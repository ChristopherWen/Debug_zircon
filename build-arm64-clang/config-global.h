...
#define GLOBAL_INCLUDES "-Isystem/public_-Isystem/private_-I./build-arm64-clang/gen/global/include"
#define GLOBAL_COMPILEFLAGS "-O2_-g_-fdebug-prefix-map=/home/wsy/zircon=._-finline_-include_./build-arm64-clang/config-global.h_-Wall_-Wextra_-Wno-multichar_-Werror_-Wno-error=deprecated-declarations_-Wno-unused-parameter_-Wno-unused-function_-Werror=unused-label_-Werror=return-type_-fno-common_-ffunction-sections_-fdata-sections_-nostdlibinc_-no-canonical-prefixes_-Wno-address-of-packed-member_-Wthread-safety_-Wimplicit-fallthrough_--target=aarch64-fuchsia"
...
#define GLOBAL_LDFLAGS "-nostdlib_--build-id_-z_noexecstack_-color-diagnostics_-m_aarch64elf_-z_max-page-size=4096_--gc-sections"
