...
#define MODULE_DEPS ""
#define MODULE_SRCS "system/dev/board/astro/astro-gpio.c_system/dev/board/astro/astro-i2c.c_system/dev/board/astro/astro-usb.c_system/dev/board/astro/astro.c"
