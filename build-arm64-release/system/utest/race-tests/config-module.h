...
#define MODULE_DEPS ""
#define MODULE_SRCS "system/utest/race-tests/race-tests.cpp"
#define MODULE_HEADER_DEPS "system/ulib/c_system/ulib/fbl_system/ulib/fdio_system/ulib/launchpad_system/ulib/unittest_system/ulib/zircon"
