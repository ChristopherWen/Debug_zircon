...
#define MODULE_SRCDEPS "./build-arm64/config-kernel.h_./build-arm64/kernel/lib/vdso/vdso-code.h_./build-arm64/kernel/lib/vdso/vdso-valid-sysret.h_./build-arm64/system/ulib/zircon/libzircon.so.strip"
