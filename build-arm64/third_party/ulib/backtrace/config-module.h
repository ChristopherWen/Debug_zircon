...
#define MODULE_SRCDEPS "./build-arm64/config-user.h_./build-arm64/system/ulib/c/gen-hdr.stamp_./build-arm64/system/ulib/zircon/gen-hdr.stamp_./build-arm64/third_party/ulib/ngunwind/gen-hdr.stamp"
#define MODULE_DEPS ""
