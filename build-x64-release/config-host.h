#pragma once
#define HOST_COMPILEFLAGS "-g_-O2_-Isystem/public_-Isystem/private_-I./build-x64-release/gen/global/include_-Wall_-Wextra_-Wno-unused-parameter_-Wno-sign-compare_--sysroot=./prebuilt/downloads/sysroot"
