...
#define MODULE_DEPS ""
#define MODULE_SRCS "system/dev/audio/intel-hda/codecs/realtek/binding.c_system/dev/audio/intel-hda/codecs/realtek/realtek-codec.cpp_system/dev/audio/intel-hda/codecs/realtek/realtek-stream.cpp"
