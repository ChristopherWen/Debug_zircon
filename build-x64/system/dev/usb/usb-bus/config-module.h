...
#define MODULE_DEPS ""
#define MODULE_SRCS "system/dev/usb/usb-bus/usb-bus.c_system/dev/usb/usb-bus/usb-device.c_system/dev/usb/usb-bus/usb-interface.c_system/dev/usb/usb-bus/util.c"
