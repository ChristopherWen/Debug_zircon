...
enum opt_code
{
  ...
  OPT_mcpu_ = 1185,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1186,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1187,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1188,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1189,                 /* -mlittle-endian */
  OPT_mlow_precision_recip_sqrt = 1190,      /* -mlow-precision-recip-sqrt */
  OPT_momit_leaf_frame_pointer = 1191,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1192,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1193,     /* -mpc-relative-literal-loads */
  OPT_mstrict_align = 1194,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1195,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1196,                     /* -mtls-size= */
  ...
  OPT_static_libmpx = 1245,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1246,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1247,               /* -static-libstdc++ */
  OPT_static_libtsan = 1248,                 /* -static-libtsan */
  OPT_static_libubsan = 1249,                /* -static-libubsan */
  ...
  OPT_std_c__98 = 1257,                      /* -std=c++98 */
  OPT_std_c11 = 1258,                        /* -std=c11 */
  /* OPT_std_c1x = 1259, */                  /* -std=c1x */
  /* OPT_std_c89 = 1260, */                  /* -std=c89 */
  OPT_std_c90 = 1261,                        /* -std=c90 */
  OPT_std_c99 = 1262,                        /* -std=c99 */
  /* OPT_std_c9x = 1263, */                  /* -std=c9x */
  OPT_std_f2003 = 1264,                      /* -std=f2003 */
  OPT_std_f2008 = 1265,                      /* -std=f2008 */
  OPT_std_f2008ts = 1266,                    /* -std=f2008ts */
  OPT_std_f95 = 1267,                        /* -std=f95 */
  OPT_std_gnu = 1268,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1269, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1270, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1271,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1272,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1273, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1274, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1275,                    /* -std=gnu++1z */
