...
enum opt_code
{
  ...
  OPT_mfunction_return_ = 1239,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1240, */              /* -mfused-madd */
  OPT_mfxsr = 1241,                          /* -mfxsr */
  OPT_mhard_float = 1242,                    /* -mhard-float */
  OPT_mhle = 1243,                           /* -mhle */
  OPT_miamcu = 1244,                         /* -miamcu */
  OPT_mieee_fp = 1245,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1246,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1247,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1248,              /* -mindirect-branch= */
  ...
  OPT_mmwaitx = 1265,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1266,            /* -mno-align-stringops */
  OPT_mno_default = 1267,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1268,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1269,                  /* -mno-push-args */
  OPT_mno_red_zone = 1270,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1271,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1272,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1273,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1274,                          /* -mpc32 */
  OPT_mpc64 = 1275,                          /* -mpc64 */
  OPT_mpc80 = 1276,                          /* -mpc80 */
  OPT_mpclmul = 1277,                        /* -mpclmul */
  OPT_mpcommit = 1278,                       /* -mpcommit */
  OPT_mpku = 1279,                           /* -mpku */
  OPT_mpopcnt = 1280,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1281,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1282,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1283,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1284,                        /* -mprfchw */
  OPT_mpush_args = 1285,                     /* -mpush-args */
  OPT_mrdrnd = 1286,                         /* -mrdrnd */
  OPT_mrdseed = 1287,                        /* -mrdseed */
  OPT_mrecip = 1288,                         /* -mrecip */
  OPT_mrecip_ = 1289,                        /* -mrecip= */
  OPT_mrecord_mcount = 1290,                 /* -mrecord-mcount */
  OPT_mred_zone = 1291,                      /* -mred-zone */
  OPT_mregparm_ = 1292,                      /* -mregparm= */
  OPT_mrtd = 1293,                           /* -mrtd */
  OPT_mrtm = 1294,                           /* -mrtm */
  OPT_msahf = 1295,                          /* -msahf */
  OPT_msha = 1296,                           /* -msha */
  OPT_mskip_rax_setup = 1297,                /* -mskip-rax-setup */
  OPT_msoft_float = 1298,                    /* -msoft-float */
  OPT_msse = 1299,                           /* -msse */
  OPT_msse2 = 1300,                          /* -msse2 */
  OPT_msse2avx = 1301,                       /* -msse2avx */
  OPT_msse3 = 1302,                          /* -msse3 */
  OPT_msse4 = 1303,                          /* -msse4 */
  OPT_msse4_1 = 1304,                        /* -msse4.1 */
  OPT_msse4_2 = 1305,                        /* -msse4.2 */
  OPT_msse4a = 1306,                         /* -msse4a */
  /* OPT_msse5 = 1307, */                    /* -msse5 */
  OPT_msseregparm = 1308,                    /* -msseregparm */
  OPT_mssse3 = 1309,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1310,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1311,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1312,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1313,            /* -mstringop-strategy= */
  OPT_mstv = 1314,                           /* -mstv */
  OPT_mtbm = 1315,                           /* -mtbm */
  OPT_mtls_dialect_ = 1316,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1317,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1318,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1319,                         /* -mtune= */
  OPT_mveclibabi_ = 1320,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1321,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1322,                    /* -mvzeroupper */
  OPT_mx32 = 1323,                           /* -mx32 */
  OPT_mxop = 1324,                           /* -mxop */
  OPT_mxsave = 1325,                         /* -mxsave */
  OPT_mxsavec = 1326,                        /* -mxsavec */
  OPT_mxsaveopt = 1327,                      /* -mxsaveopt */
  OPT_mxsaves = 1328,                        /* -mxsaves */
  OPT_n = 1329,                              /* -n */
